...
namespace Charlotte.Services.Salad.Uploader
{
	...
	{
		public const string GROUP_BUNDLE_DIR = @"C:\appdata\Post2.Corona.Salad.Uploader";
		...
		public const string SESSION_BUNDLE_FILE = @"C:\appdata\Post2.Corona.Salad.Uploader.Session.txt";
